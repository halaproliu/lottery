/**
 * @Author: brecht
 * @Date: 2021-08-17 14:29:30
 * @LastEditTime: 2021-08-25 11:58:35
 * @LastEditors: brecht
 * @Description: 日期处理
 * @FilePath: /berserker-fe/src/lib/date.js
 */
 export const formatDate = (date, fmt) => {
   ...
   * @return {*}
   **/
  export const getDurationTime = (duration = 1, type = 'd', returnType = 0, fmt) => {
    let date = new Date()
    let year = date.getFullYear()
    let month = date.getMonth()
    let day = date.getDate()
